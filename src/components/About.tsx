...
const About = () => {
  return (
    <div className="flex flex-col  items-end px-5 gap-4 w-full h-full">
      ...
      <h1 className="text-5xl leading-none text-end max-w-5xl font-semibold mt-10">
      ...
      <div className="flex flex-row gap-10 justify-center items-center self-end py-2 px-4 mt-10">
