...
const About = () => {
  return (
    <div className="flex flex-col justify-center items-center md:items-end px-5 gap-4 md:w-full md:h-full">
      ...
      <h1 className="text-5xl leading-none text-center md:text-end max-w-5xl font-semibold md:mt-10">
        Code, Story, and <span className="text-[#58C4DC]">Beyound</span>
      </h1>
      <p className="max-w-3xl text-lg text-center md:text-end text-primary mt-10">
      ...
      <p className="max-w-3xl text-lg text-center md:text-end text-primary mt-5">
