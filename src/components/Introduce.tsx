...
const Introduce = () => {
  return (
    <div className="flex flex-col md:items-end px-5 gap-4 w-full h-full">
      ...
      <h1 className="text-4xl md:text-[78px] leading-none text-center md:text-end md:max-w-5xl font-semibold md:mt-20">
        I'm <span className="text-[#58C4DC]">Marchenda</span>,
        <br />
        Junior Full-Stack Web Developer
      </h1>
      <p className="md:text-lg text-center md:text-end text-primary md:max-w-3xl mt-5 md:mt-10">
